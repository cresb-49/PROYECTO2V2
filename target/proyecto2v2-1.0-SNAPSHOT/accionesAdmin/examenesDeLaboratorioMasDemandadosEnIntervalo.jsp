<%-- 
    Document   : examenesDeLaboratorioMasDemandadosEnIntervalo
    Created on : 2/10/2020, 03:14:07
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Examenes mas requeridos en un intervalo de tiempo</title>
        ...
        <div class="container">
            <table class="table">
                ...
                <tbody>
                    ...
                    <c:forEach items="${examDem}" var="ex">
                        <tr>
                            <td>${ex[0]}</td>
                            <td>${ex[1]}</td>
                            <td>${ex[2]}</td>
