<%-- 
    Document   : errorReporte
    Created on : 3/10/2020, 21:20:03
    Author     : carlo
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br/>
            <h5><a href="${pageContext.request.contextPath}/Medico/citasDiaCurso.jsp" >Regresar Citas del Dia</a></h5>
            <br/>
        </div>
        <%
        } else {
