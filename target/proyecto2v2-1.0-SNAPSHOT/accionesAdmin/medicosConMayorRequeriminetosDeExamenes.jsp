<%-- 
    Document   : medicosConMayorRequeriminetosDeExamenes
    Created on : 2/10/2020, 03:03:02
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Medicos con mas requeriminetos de examenes</title>
    ...
    <body>
        <header>
            <div class="container">
                <h1>HOSPITAL</h1>
                <h5>Medicos con mas requeriminetos de examenes</h5>
        ...
        <div class="container">
            <table class="table">
                ...
                <tbody>
                    ...
                    <c:forEach items="${medRe}" var="cita">
                        <tr>
                            <td>${cita[0]}</td>
                            <td>${cita[1]}</td>
                            <td>${cita[2]}</td>
