<%-- 
    Document   : CantidadExamenesIntervalo
    Created on : 2/10/2020, 01:27:47
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Cantidad de Examenes</title>
        ...
        <div class="container">
            <table class="table">
                ...
                <tbody>
                    ...
                    <c:forEach items="${cantidad}" var="ex">
                        <tr>
                            <td>${ex[0]}</td>
                            <td>${ex[1]}</td>
                        </tr>
