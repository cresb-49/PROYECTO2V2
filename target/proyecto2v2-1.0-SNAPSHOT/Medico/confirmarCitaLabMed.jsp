<%-- 
    Document   : confirmarCitaLabMed
    Created on : 3/10/2020, 02:42:40
    Author     : carlo
--%>
...
<html>
    ...
    <body>
        <header>
            <div class="container">
                <h1>HOSPITAL</h1>
                <h5><a href="${pageContext.request.contextPath}//ReportesMedico?reporte=5" >Retornar a examenes</a></h5>
                <br/>
            </div>
        </header>
        <div class="container">
            <form class="container form-group" action="${pageContext.request.contextPath}/ControladorCitaLabMed" method="POST" onsubmit="return validarCitaLab();" enctype="multipart/form-data">
                <div class="form-row form-group">
                    ...
                    <div class="container form-group col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <label class="control-label" for="codePaciente">Codigo Paciente: </label>
                            <div class="">
                                <input class="form-control" id="codePaciente" type="text" name="codePaciente"  placeholder="Codigo Paciente">
                            </div>
                        </div>
                    </div>
                    <div class="container form-group col-md-6">
