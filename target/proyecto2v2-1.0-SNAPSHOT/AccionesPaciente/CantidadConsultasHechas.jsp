<%-- 
    Document   : CantidadConsultasHechas
    Created on : 2/10/2020, 01:48:25
    Author     : carlo
--%>
...
<html>
    <head>
        ...
        <title>Cantidad de Consultas hechas</title>
    ...
    <body>
        <header>
            <div class="container">
                <h1>HOSPITAL</h1>
                <h5>Catnidad de consultas por medico</h5>
        ...
        <div class="container">
            ...
            <br/>
            <form method="GET" action="${pageContext.request.contextPath}/ReportesPaciente">
                <div class="form-row">
        ...
        <div class="container">
            <table class="table">
                ...
                <c:forEach items="${canConsutlas}" var="con">
                    <tr>
                        <td>${con[0]}</td>
                        <td>${con[1]}</td>
                        <td>${con[2]}</td>
