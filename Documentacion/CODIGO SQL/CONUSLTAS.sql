...
/////////
SELECT COUNT(RESULTADO.MEDICO_codigo) AS C, MEDICO.codigo,MEDICO.nombre  FROM RESULTADO INNER JOIN MEDICO ON RESULTADO.MEDICO_codigo = MEDICO.codigo AND RESULTADO.fecha BETWEEN "2020-09-06" AND "2020-09-06" GROUP BY MEDICO.codigo ORDER BY C DESC;
